    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="bg-white/90 dark:bg-gray-800 shadow-lg rounded-2xl p-8 w-full max-w-2xl border border-gray-200 dark:border-gray-700">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-6 border-b pb-3">
          {formData._id ? "Update Project Info" : "Add Project Info"}
        </h2>
      ...
      <div className="mt-10 w-full max-w-3xl">
        ...
        {data && data.length > 0 ? (
            ...
            {data.map((item) => (
              ...
              >
                ...
                <div className="space-y-1 text-gray-700 dark:text-gray-200">
                  ...
                  <p><span className="font-semibold">Technologies:</span> {item.technologies}</p>
                  <p><span className="font-semibold">Website:</span> <a href={item.website} target="_blank" className="text-blue-600 hover:underline">{item.website}</a></p>
                  <p><span className="font-semibold">Github:</span> <a href={item.github} target="_blank" className="text-blue-600 hover:underline">{item.github}</a></p>
                </div>
          ...
          <p className="text-gray-600 dark:text-gray-400 italic">No projects found.</p>
        )}
      </div>
    </div>
  );
