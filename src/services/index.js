...
export async function addData(currentTab, formData) {
  try {
    console.log("Sending add request:", { url: `/api/${currentTab}/add`, formData });
...
export async function updateData(currentTab, formData) {
  try {
    ...
    console.log("Sending update request:", { url: `/api/${currentTab}/update`, formData });
...
export async function deleteData(currentTab, id) {
  try {
    console.log("Sending delete request:", { url: `/api/${currentTab}/delete?id=${encodeURIComponent(id)}`, id });
...
export async function login(formData) {
  try {
    console.log("Sending login request:", { url: "/api/login", formData });
